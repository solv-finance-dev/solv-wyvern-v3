...
contract StaticMarket {
    ...
    function anyERC3525ForERC20(
        ...
        require(
            ...
            "anyERC3525ForERC20: call must be a direct call"
        );
        ...
        require(
            ...
            "anyERC20ForERC3525: numerator must be larger than zero"
        );
        require(
            tokenIdAndNumeratorDenominator[2] > 0,
            "anyERC20ForERC3525: denominator must be larger than zero"
        );
        require(
            addresses[2] == tokenGiveGet[0],
            "anyERC3525ForERC20: call target must equal address of token to give"
        );
        require(
            addresses[5] == tokenGiveGet[1],
            "anyERC3525ForERC20: countercall target must equal address of token to get"
        );
        ...
        require(
            ...
            "anyERC3525ForERC20: wrong ratio"
        );
        checkERC3525Side(
            data,
            addresses[1],
    ...
    function anyERC20ForERC3525(
        ...
        require(
            howToCalls[0] == AuthenticatedProxy.HowToCall.Call,
            "anyERC20ForERC3525: call must be a direct call"
        );
        ...
        require(
            addresses[2] == tokenGiveGet[0],
            "anyERC20ForERC3525: call target must equal address of token to get"
        );
        require(
            addresses[5] == tokenGiveGet[1],
            "anyERC20ForERC3525: countercall target must equal address of token to give"
        );

        uint256[2] memory call_amounts = [
            getERC3525AmountFromCalldata(counterdata),
        ...
        require(
            ...
            "anyERC20ForERC3525: wrong ratio"
        );
        checkERC3525Side(
            counterdata,
            addresses[4],
    ...
    function getERC3525AmountFromCalldata(bytes memory data)
        internal
        pure
        returns (uint256)
    {
